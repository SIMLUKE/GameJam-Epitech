...
signal change_scene(prev_scene, new_scene)
...
const LEVEL5_SCENE = preload("res://scenes/level5.tscn")
...
func _on_player_win() -> void:
	...
	if (get_node_or_null("level3") != null):
		$"level3".queue_free()
	if (get_node_or_null("level4") != null):
		$"level4".queue_free()
	if (get_node_or_null("level5") != null):
		$"level5".queue_free()
...
func _on_change_scene(prev_scene: Variant, new_scene: Variant) -> void:
